...
contract CommitRecover {
     ...
     */
    function _commit(uint256 _c) internal shouldBeLessThanN(_c) {
        ...
        _commitsString = string.concat(_commitsString, Pietrzak_VDF.toString(_c));
        userInfosAtRound[msg.sender][round] = UserAtRound(_count, true, false);
        commitRevealValues[round][_count] = CommitRevealValue(_c, 0, msg.sender); //index starts from 0, so _count -1
